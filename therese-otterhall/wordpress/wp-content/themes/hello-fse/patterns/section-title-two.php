<?php
  ...
  * Slug: hello-fse/section-title-two
...
<p class="has-text-align-left has-primary-color has-text-color has-medium-font-size" style="letter-spacing:1px"><?php echo esc_html__( 'Section Sub Title Here', 'hello-fse' ); ?></p>
<!-- /wp:paragraph -->
...
<h2 class="has-text-align-center animated animated-fadeInUp has-slider-title-font-size" style="line-height:1.3"><?php echo esc_html__( 'Section Main Title Here', 'hello-fse' ); ?></h2>
<!-- /wp:heading --></div>
<!-- /wp:group -->
